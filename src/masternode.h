...
#define MASTERNODE_MIN_MNP_SECONDS (5 * 60) // 10 * 60
#define MASTERNODE_MIN_MNB_SECONDS (5 * 60)
#define MASTERNODE_PING_SECONDS (5 * 60)
#define MASTERNODE_EXPIRATION_SECONDS (7 * 24 * 60 * 60)
#define MASTERNODE_REMOVAL_SECONDS (((7 * 24) + 1) * 60 * 60)
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the MASTERNODE_COINS CSTL, signature to prove
