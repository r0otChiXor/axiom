...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/MyCryptoCoins/Castle/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/MyCryptoCoins/gitian.sigs.git
    git clone https://github.com/MyCryptoCoins/Castle-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/MyCryptoCoins/Castle.git castle
...
### Build and sign Castle Core for Linux, Windows, and OS X:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs/ ../castle/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/castle-*.tar.gz build/out/src/castle-*.tar.gz ../
    popd
...
- Detached signatures will then be committed to the [castle-detached-sigs](https://github.com/MyCryptoCoins/Castle-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/MyCryptoCoins/Castle/releases/new) with a link to the archived release notes.
