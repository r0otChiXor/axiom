...
*Setup instructions for a gitian build of Castle using a Debian VM or physical system.*
...
To build Castle (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/MyCryptoCoins/Castle
...
[MyCryptoCoins/gitian.sigs](https://github.com/MyCryptoCoins/gitian.sigs/) repository, or if that's not possible to create a pull
request.
