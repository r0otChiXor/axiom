...
2. [Sending 10,000 Castle to new wallet addresses.](#option2)
...
### Send 10,000 Castle to New Addresses

Just like setting up a standard MN. Send exactly 10,000 Castle to each new address created above.
...
*Please note, the masternode priviate key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 10,000 Castle on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the castle github repo](https://github.com/MyCryptoCoins/Castle/blob/master/doc/masternode_conf.md)
